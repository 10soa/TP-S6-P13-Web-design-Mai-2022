    ...
    <div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form action="traitement.php?updateCons=0" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
											 <textarea id="w3review" name="info" rows="4" cols="250" value="<?php echo  $_GET['info'] ?>"></textarea>
											</div>
										</div>
