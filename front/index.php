...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      <h1 class="logo me-auto"><a>Planete<span>.</span></a></h1>
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <div class="row">
        <div class="col-xl-6">
          <h1 style="color:rgb(175,0,0)">Rechauffement climatique</h1>
          <h2>Augmentation constante de la température moyenne mondiale</h2>
          ...
          <div class="tab-pane active show" id="tab-1">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0" data-aos="fade-up" data-aos-delay="100">
                <h3>Definition</h3>
                <ul>
                  <li><i class="ri-check-double-line"></i> Definition simple</li>
                <p class="fst-italic">
                  ...
                  <li><i class="ri-check-double-line"></i> Definition scientifique</li>
                  <p class="fst-italic">
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>ETU 001168</span></strong>RANDRIAMAMBOLA Soatoavina Koloina Ornella
        </div>
        <div class="credits">
