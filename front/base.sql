...
insert into Luttes values(null,'Favoriser les modes de travail écologiques','Certains modes de travail sont plus écologiques que d\’autres : le télétravail par exemple a de nombreux avantages du point de vue écologique. On peut aussi penser aux vidéos-conférences qui évitent aux employés d\’avoir à se déplacer en voiture pour les réunions avec certains clients.
...
insert into Luttes values(null,'Utiliser les énergies renouvelables','Aujourd\’hui, de plus en plus de particuliers font le choix de l\’énergie renouvelable, et pour les entreprises aussi c\’est une solution intéressante. Les fournisseurs comme Lampiris ou Enercoop représentent d\’ailleurs une solution intéressante pour n\’utiliser que de l\’énergie 100% renouvelable. En évitant les énergies fossiles, on réduit sensiblement son empreinte sur le climat.');
insert into Luttes values(null,'Réduire sa consommation d\’énergie','Éteindre les lumières en partant du bureau le soir, baisser légèrement le chauffage ou la climatisation, éteindre les prises lorsqu\’elles ne sont pas utilisées… En faisant attention au quotidien, les entreprises peuvent réduire légèrement leur consommation d\’énergie et donc leur impact sur le climat.
...
insert into admin values(null,'admin','1234');
